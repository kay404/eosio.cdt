 ...
 * @ingroup contracts
 * @ingroup types
 * @brief Defines contract type which is %base class for every ICBS contract
 */
 ...
 * @ingroup contract
 */
#define CONTRACT class [[icbs::contract]]
#define ACTION   [[icbs::action]] void
#define TABLE struct [[icbs::table]]

namespace icbs {

/**
 * %Base class for ICBS contract.
 *
 * @ingroup contract
 * @details %A new contract should derive from this class, so it can make use of ICBS_ABI macro.
 */
class contract {
   public:
      /**
