...
/**
  ...
  *  icbs_assert(itr >= 0, "Alice cannot be removed since she was already not found in the table");
  *  db_remove_i64(itr);
  *  @endcode
  */
__attribute__((eosio_wasm_import))
...
/**
  ...
  *  icbs_assert(len <= 50, "buffer to small to store retrieved record");
...
/**
  ...
  *  icbs_assert(end_itr < -1, "Charlie was not the last entry in the table");
  *  @endcode
  */
__attribute__((eosio_wasm_import))
