...
namespace icbs {
   ...
   /**
    *  Serialize an icbs::webauthn_public_key into a stream
    *
    *  @ingroup public_key
   ...
   inline DataStream& operator<<(DataStream& ds, const icbs::webauthn_public_key& pubkey) {
      ds << pubkey.key << pubkey.user_presence << pubkey.rpid;
      return ds;
   }

   /**
    *  Deserialize an icbs::webauthn_public_key from a stream
    *
    *  @ingroup public_key
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, icbs::webauthn_public_key& pubkey) {
      ds >> pubkey.key >> pubkey.user_presence >> pubkey.rpid;
      return ds;
   }
   ...
   /**
    *  Serialize an icbs::webauthn_signature into a stream
    *
    *  @param ds - The stream to write
    ...
    */
   template<typename DataStream>
   inline DataStream& operator<<(DataStream& ds, const icbs::webauthn_signature& sig) {
      ds << sig.compact_signature << sig.auth_data << sig.client_json;
      return ds;
   }

   /**
    *  Deserialize an icbs::webauthn_signature from a stream
    *
    *  @param ds - The stream to read
    ...
    */
   template<typename DataStream>
   inline DataStream& operator>>(DataStream& ds, icbs::webauthn_signature& sig) {
      ds >> sig.compact_signature >> sig.auth_data >> sig.client_json;
      return ds;
   }
    ...
    */
   void assert_sha256( const char* data, uint32_t length, const icbs::checksum256& hash );
    ...
    *  @note This method is optimized to a NO-OP when in fast evaluation mode.
    */
   void assert_sha1( const char* data, uint32_t length, const icbs::checksum160& hash );
    ...
    *  @note This method is optimized to a NO-OP when in fast evaluation mode.
    */
   void assert_sha512( const char* data, uint32_t length, const icbs::checksum512& hash );
    ...
    *  @param hash - digest to compare to
    */
   void assert_ripemd160( const char* data, uint32_t length, const icbs::checksum160& hash );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return icbs::checksum256 - Computed digest
    */
   icbs::checksum256 sha256( const char* data, uint32_t length );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return icbs::checksum160 - Computed digest
    */
   icbs::checksum160 sha1( const char* data, uint32_t length );
    ...
    *  @param data - Data you want to hash
    *  @param length - Data length
    *  @return icbs::checksum512 - Computed digest
    */
   icbs::checksum512 sha512( const char* data, uint32_t length );
    ...
    *  @return icbs::checksum160 - Computed digest
    */
   icbs::checksum160 ripemd160( const char* data, uint32_t length );
    ...
    *  @param sig - Signature
    *  @return icbs::public_key - Recovered public key
    */
   icbs::public_key recover_key( const icbs::checksum256& digest, const icbs::signature& sig );
    ...
    */
   void assert_recover_key( const icbs::checksum256& digest, const icbs::signature& sig, const icbs::public_key& pubkey );
}
