...
namespace icbs {
   ...
   namespace internal_use_do_not_use {
      extern "C" {
         ...
         __attribute__((eosio_wasm_import))
         void icbs_assert_message( uint32_t test, const char* msg, uint32_t msg_len );
    ...
    *  @ingroup core
    *  @brief Defines wrappers over icbs_assert
    */
    ...
    *  Example:
    *  @code
    *  icbs::check(a == b, "a does not equal b");
    *  @endcode
    */
   inline void check(bool pred, const char* msg) {
      if (!pred) {
         internal_use_do_not_use::icbs_assert(false, msg);
      }
   }
   ...
   inline void check(bool pred, const std::string& msg) {
      if (!pred) {
         internal_use_do_not_use::icbs_assert(false, msg.c_str());
      }
   }
    ...
    *  icbs::check(a == b, "a does not equal b", 18);
    *  @endcode
    */
   inline void check(bool pred, const char* msg, size_t n) {
      if (!pred) {
         internal_use_do_not_use::icbs_assert_message(false, msg, n);
      }
   }
    ...
    *  icbs::check(a == b, msg, 18);
    *  @endcode
    */
   inline void check(bool pred, const std::string& msg, size_t n) {
      if (!pred) {
         internal_use_do_not_use::icbs_assert_message(false, msg.c_str(), n);
      }
   }
   ...
   inline void check(bool pred, uint64_t code) {
      if (!pred) {
         internal_use_do_not_use::icbs_assert_code(false, code);
      }
   }
} // namespace icbs
