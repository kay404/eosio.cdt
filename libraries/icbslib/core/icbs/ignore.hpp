...
namespace icbs {
   ...
   inline DataStream& operator<<(DataStream& ds, const ::icbs::ignore_wrapper<T>& val) {
     ds << val.value;
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator<<(DataStream& ds, const ::icbs::ignore<T>& val) {
     return ds;
   }
    ...
    */
   template<typename DataStream, typename T>
   inline DataStream& operator>>(DataStream& ds, ::icbs::ignore<T>&) {
     return ds;
   }
}
