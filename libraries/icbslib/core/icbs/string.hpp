/**
 *  @file
 *  @copyright defined in icbs.cdt/LICENSE.txt
 */
...
#include "datastream.hpp" // icbs::datastream
#include "varint.hpp"     // icbs::unsigned_int
...
namespace icbs {
   ...
   public:
      ...
      char& at(const size_t n) {
         icbs::check(0 <= n && n < _size, "icbs::string::at");
         return operator[](n);
      }

      const char at(const size_t n) const {
         icbs::check(0 <= n && n < _size, "icbs::string::at const");
         return operator[](n);
      }
      ...
      size_t copy(char* s, size_t len, size_t pos = 0) const {
         icbs::check(pos <= _size, "icbs::string::copy");
      ...
      string& insert(const size_t pos, const char* str, const size_t len) {
         icbs::check((str != nullptr) && (0 <= pos && pos <= _size), "icbs::string::insert");
      ...
      string& erase(size_t pos = 0, size_t len = npos) {
         icbs::check(0 <= pos && pos <= _size, "icbs::string::erase");
      ...
      string& append(const char* str) {
         icbs::check(str != nullptr, "icbs::string::append");
         insert(_size, str);
